...
public: 
    ...
    template<class U>
    void push_front(U&& v); //wstawianie elemntu do listy  
    T pop_front();

    template<class U>
    void push_back(U&& v); //wstawianie elemntu do listy  
    T pop_back();  //usuwanie elemntu ze listy
    ...
    // Wstawia element x przed pozycję
